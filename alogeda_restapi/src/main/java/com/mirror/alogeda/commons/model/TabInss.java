...
/**
 * TabInss generated by hbm2java
 */
@Entity
@Table(name = "tab_inss", schema = "public")
@SequenceGenerator(name = "tabinss_seq", sequenceName = "tabinss_seq", allocationSize = 1)
public class TabInss implements java.io.Serializable {
    ...
    public TabInss(int id) {
        this.id = id;
    }

    public TabInss(int id, Double valInicial, Double valFinal, Double percentual, Date perInicial, Date perFinal) {
        this.id = id;
    ...
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "tabinss_seq")
    public int getId() {
        return this.id;
    }
